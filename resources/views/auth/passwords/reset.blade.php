                ...
                <div class="card-body" style="background-color: rgb(26, 26, 26)">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="email" style="background-color: rgb(26, 26, 26); color: white" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}" required autofocus>
